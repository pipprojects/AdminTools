...
#
cd $ADMINTOOLSLOGS
echo "backuplvs.ksh $OPTION -f $CONFILE -l $ADMINTOOLSLOGS -u $MARK -t $TAPEDEV -g $GRAPH -M n > $LOGFILE 2>&1"
backuplvs.ksh $OPTION -f $CONFILE -l $ADMINTOOLSLOGS -u $MARK -t $TAPEDEV -g $GRAPH -M n > $LOGFILE 2>&1
if [ $? = 0 ]
then
